package com.alejandro.marketplace.adapter;
...
//Se encarga de conectar la lista de objetos Producto con el diseño de la tarjetaitem_producto.xml.
public class ProductoAdapter extends
    ...
    public ProductoViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.item_productos, parent,
                false);
