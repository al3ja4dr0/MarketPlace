...
public class LoginActivity extends AppCompatActivity {
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginActivity.this, "Fallo la autenticación: Usuario No Registrado! ",
    ...
    public void irAHome() {
        ...
        // Estas flags son cruciales para que el usuario no pueda volver al Login con el botón deretroceso
