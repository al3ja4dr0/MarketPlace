...
public class RegistroActivity extends AppCompatActivity {
        ...
        mAuth.createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(RegistroActivity.this, "¡Registro exitoso! Bienvenido.",
                        ...
                        Toast.makeText(RegistroActivity.this, "Fallo el registro: " + errorMessage,
    ...
    private void guardarDatosUsuario(String uid, String nombre, String email) {
        ...
        userData.put("fecha_creacion", System.currentTimeMillis()); // Marca de tiempo enmilisegundos
