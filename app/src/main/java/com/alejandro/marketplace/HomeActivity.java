...
import com.alejandro.marketplace.adapter.ProductoAdapter;
...
public class HomeActivity extends AppCompatActivity {
    ...
    private List<producto> cargarProductosDePrueba() {
        ...
        lista.add(new producto("ID003", "Libro: El Señor de los Anillos", "Edición de lujo tapadura.", "29.990", "url_ficticia_3"));
